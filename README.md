...
| `{ candor: { version, toolchain, spec: "0.22" }, functions }` envelope; pure fns omitted | SPEC §2/§2.1 |
...
0.19.x, speaking candor-spec 0.22: the analysis core, the gate (`--policy` / `--gate-json` /
