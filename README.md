...
| `{ candor: { version, toolchain, spec: "0.35" }, functions }` envelope; pure fns omitted | SPEC §2/§2.1 |
...
0.30.0, speaking candor-spec 0.35: the analysis core, the gate (`--policy` / `--gate-json` /
